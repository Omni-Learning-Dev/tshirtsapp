...
@section('content')
    <section id="Section-3" class="section-3">
        ...
        <div class="form-border">
            <h1 class="heading-4">CUSTOM HOODIES</h1>

            <div class="form-block w-form">
                <form action="{{ route('hoodie.order') }}" method="POST" enctype="multipart/form-data" class="form">
                    @csrf
                    ...
                    <div class="color-selector">
                        ...
                        <label class="color-option">
                            <input type="radio" name="color" value="Maroon" class="color-radio" {{ old('color') == 'Maroon' ? 'checked' : '' }}>
